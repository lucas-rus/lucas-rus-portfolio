        ...
        <div className="space-y-5 sm:space-y-8">
          ...
          <FadeIn delay={0.4} className="glass-card p-4 sm:p-6 md:p-7 rounded-2xl border border-white/5 hover:border-emerald-500/40 transition-all bg-slate-900/50">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 sm:mb-4 gap-2">
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-lg sm:text-xl font-bold text-white">AI Alignment Specialist &amp; Prompt Engineer</h3>
            ...
            <p className="text-slate-300 text-sm leading-relaxed mb-3 sm:mb-4">
              Conducted specialized RLHF audits and adversarial red-teaming for frontier LLMs, with a core focus on Romanian-English localized prompts, cultural nuance verification, and idiomatic accuracy. Evaluated model truthfulness, grammar subtleties, policy adherence, and multi-turn instruction following against strict multi-axis rubrics.
            </p>

            <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-3 sm:pt-4 border-t border-white/5">
              <span className="px-2.5 py-1 bg-emerald-900/30 text-emerald-200 text-xs rounded-lg border border-emerald-500/20">Romanian Localized Prompts</span>
              <span className="px-2.5 py-1 bg-teal-900/30 text-teal-200 text-xs rounded-lg border border-teal-500/20">Prompt Engineering</span>
